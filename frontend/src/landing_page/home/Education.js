    ...
    return (  
        <div className='container mt-5'> 
            <div className='row'>
                ...
                <div className='col-6'>
                   <img src='media/img/education.svg' style={{width:"70%"}} />
                </div>

                <div className='col-6'>
                     <h1 className='mb-3 fs-2'>Free and open market education</h1>
                    <p>Varsity, the largest online stock market education book in the world covering everthing from the basic to advanced trading,</p>
