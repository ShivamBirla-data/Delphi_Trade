            ...
            <div className='row p-5 mt-5 mb-5'>
                <div className='fs-2 text-center'>
                 ...
                 <div className='col-4 p-5'>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Charges at Opening</a><br/>
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Delphi IDFC FIRST Bank 3-in-1 Account</a><br/>
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Getting Started</a>
                </div>
                <div className='col-4 p-5'>
                    <h4><i class="fa fa-plus" aria-hidden="true"></i>
                    Your Delphi Account </h4>
                 ...
                 <div className='col-4 p-5'>
                   ...
                   Console </h4>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>60 Day chanllenge</a><br/>
                 ...
                 <div className='col-4 p-5'>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Moving App</a><br/>
